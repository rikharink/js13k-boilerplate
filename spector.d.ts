...
declare namespace SPECTOR {
  interface IStackTrace {
    getStackTrace(
      removeFirstNCalls?: number,
      removeLastNCalls?: number,
    ): string[];
  }
...
declare namespace SPECTOR {
  class OriginFunctionHelper {
    ...
    static storePrototypeOriginFunction(
      object: any,
      functionName: string,
    ): void;
    static executePrototypeOriginFunction(
      object: any,
      objectType: any,
      functionName: string,
      args: IArguments,
    ): any;
    static executeOriginFunction(
      object: any,
      functionName: string,
      args: IArguments,
    ): any;
...
declare namespace SPECTOR.Recorders {
  abstract class BaseRecorder<T extends WebGLObject> implements IRecorder {
    ...
    protected createWithoutSideEffects(
      functionInformation: IFunctionInformation,
    ): void;
    protected updateWithoutSideEffects(
      functionInformation: IFunctionInformation,
    ): void;
    protected deleteWithoutSideEffects(
      functionInformation: IFunctionInformation,
    ): void;
...
declare namespace SPECTOR.Recorders {
  class RenderBufferRecorder extends BaseRecorder<WebGLRenderbuffer> {
    ...
    protected update(
      functionInformation: IFunctionInformation,
      target: string,
      instance: WebGLRenderbuffer,
    ): number;
    protected getCustomData(
      functionInformation: IFunctionInformation,
      target: string,
    ): IRenderBufferRecorderData;
  }
}
declare namespace SPECTOR {
...
declare namespace SPECTOR.States {
  ...
  abstract class BaseState implements IState {
    ...
    protected isValidChangeCommand(
    ...
    protected changeCommandCaptureStatus(
...
declare namespace SPECTOR.States {
  class DrawCallState extends BaseState {
    ...
    protected readAttributeFromContext(
      program: WebGLProgram,
      activeAttributeIndex: number,
    ): {};
    protected readUniformFromContext(
      program: WebGLProgram,
      activeUniformIndex: number,
    ): {};
    protected readTextureFromContext(
      textureUnit: number,
      target: WebGlConstant,
    ): {};
    protected getTextureStorage(target: WebGlConstant): any;
    protected readUniformsFromContextIntoState(
      program: WebGLProgram,
      uniformIndices: number[],
      uniformsState: any[],
    ): void;
    protected readTransformFeedbackFromContext(
      program: WebGLProgram,
      index: number,
    ): {};
    protected readUniformBlockFromContext(
      program: WebGLProgram,
      index: number,
    ): {};
...
declare namespace SPECTOR.States {
  class DrawCallTextureInputState {
    ...
    protected getTextureVisualState(
      target: WebGlConstant,
      storage: WebGLTexture,
      info: ITextureRecorderData,
    ): any;
    protected getCapture(
      gl: WebGLRenderingContext,
      x: number,
...
declare namespace SPECTOR.Analysers {
  abstract class BaseAnalyser implements IAnalyser {
    ...
    appendAnalysis(capture: ICapture): void;
    getAnalysis(capture: ICapture): IAnalysis;
    protected abstract appendToAnalysis(
      capture: ICapture,
      analysis: IAnalysis,
    ): void;
  }
...
declare namespace SPECTOR {
  interface ICommandComparator {
    compare(
      commandA: ICommandCapture,
      commandB: ICommandCapture,
    ): ICommandCaptureComparison;
  }
...
declare namespace SPECTOR.EmbeddedFrontend {
  ...
  abstract class BaseComponent<T> extends BaseNoneGenericComponent {
    ...
    addEventListener(
      command: string,
      callback: (stateEventArgs: IStateEventArgs<T>) => void,
      context?: any,
    ): number;
    removeEventListener(command: string, listenerId: number): void;
    protected renderElementFromTemplate(
      template: string,
      state: T,
      stateId: number,
    ): Element;
    ...
    protected bindCommand(
      commandContainer: Element,
      state: T,
      stateId: number,
    ): void;
    protected mapEventListener(
      domElement: Element,
      domEvent: string,
      eventName: string,
      state: T,
      stateId: number,
      commandCapture?: boolean,
...
declare namespace SPECTOR.EmbeddedFrontend {
  class MVX {
    ...
    updateAllChildrenState(
      id: number,
      updateCallback: (state: any) => any,
    ): void;
    updateAllChildrenGenericState<T>(
      id: number,
      updateCallback: (state: T) => T,
    ): void;
...
declare namespace SPECTOR {
  ...
  interface ICaptureMenu {
    ...
    updateCanvasesListInformation(
      canvasesInformation: ICanvasInformation[],
    ): void;
...
declare namespace SPECTOR {
  ...
  class Spector {
    private options;
    static getFirstAvailable3dContext(
